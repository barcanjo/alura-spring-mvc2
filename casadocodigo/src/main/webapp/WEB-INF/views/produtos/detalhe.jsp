...
<body class="produto">
  ...
  <header id="layout-header">
    ...
    <article id="${produto.id}">
      ...
      <!-- Usa o form do Spring para poder gerar o _csrf token para o Spring Security -->  
      <form:form servletRelativeAction="/carrinho/adicionar" method="post" cssClass="container">
